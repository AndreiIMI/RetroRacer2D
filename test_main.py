...
def main():
    ...
    while True:
        ...
        hill_road(road_acceleration, texture_position_threshold, screen, globals.font, half_texture_position_threshold, light_road, dark_road, ddz, texture_position_acceleration, -0.003)
        S_curved_road(road_acceleration, texture_position_threshold,screen, globals.font, half_texture_position_threshold,light_strip, light_road, dark_strip, dark_road, ddz, texture_position_acceleration, 0.01)
